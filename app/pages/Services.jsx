...
export default function Services() {
    return (
        <main id='Services' className="bg-[#0a1c28] w-full pt-12 md:py-10">
            ...
            <section className="w-full grid grid-cols-1 lg:grid-cols-3 gap-8 px-7 md:px-8 grid-1 w-full lg:px-11">
